 ...
 * VPaciente.java
 *
 * Created on 29/11/2014, 01:27:10
 */
...
public class VPaciente extends javax.swing.JDialog {
    public static final String BTN_GUARDAR="guardar datos de paciente";
    public static final String BTN_MODIFICAR="modificar datos de paciente";
    public static final String BTN_BUSCAR="buscar datos de paciente";
    public static final String BTN_ELIMINAR="eliminar datos de paciente";
    ...
    public void cargarOSocial(Object lista[]){
    ...
    public void setObrasocial(int index){
